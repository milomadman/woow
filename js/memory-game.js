class MemoryGame {
    ...
    cardClicked(e) {
        ...
        if (this.matchCards(this.clickedCards[0].getAttribute('data-card'), this.clickedCards[1].getAttribute('data-card'))) {
            ...
            var uniid = e.currentTarget.getAttribute('data-card'); uniid --;
            var uniname = myJson.data[uniid].name;
            var unisize = myJson.data[uniid].Einradgr;
            var uniort = myJson.data[uniid].Ort
            uniid ++;


            var img = document.createElement("img");
            if (uniid<10) {
                img.src = "../Einrad-Fotos/Memory/0" + uniid +".jpg";
            } else {img.src = "../Einrad-Fotos/Memory/" + uniid +".jpg"}
            ...
            setTimeout(() => {
                ...
                document.getElementById("uniname").innerHTML = uniname;
                document.getElementById("unisize").innerHTML = unisize;
                document.getElementById("uniort").innerHTML = uniort;
    ...
    shouldIclose(){
        //here I want to write code, so that if something is clicked the modal closes
    }
...
let myJson = {"data": [
    {
      "id": 1,
      "name": "MUNI (Mountain Unicycling)",
      "Einradgr": "24-29 Zoll",
      "Ort": "Berge und Wälder",
    },
    {
      "id": 2,
      "name": "Trial",
      "Einradgr": "20 Zoll",
      "Ort": "Überall wo Hindernisse sind",
    },
    {
      "id": 3,
      "name": "Flatland",
      "Einradgr": "20 Zoll",
      "Ort": "auf hartem flachem Boden",
    },
    {
      "id": 4,
      "name": "Street",
      "Einradgr": "20 Zoll",
      "Ort": "Skatepark oder in den Strassen",
    },
    {
      "id": 5,
      "name": "Hochsprung",
      "Einradgr": "20 Zoll",
      "Ort": "drin oder draussen, über Stangen oder auf Palletten",
    },
    {
      "id": 6,
      "name": "Weitsprung",
      "Einradgr": "20 - 29 Zoll",
      "Ort": "auf einer Bahn oder von Palletten zu Palletten",
    },
    {
      "id": 7,
      "name": "Bahnrennen",
